                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea id="terms_conditions" name="terms_conditions" rows="4" class="form-control editor">{{ !empty($sitecontent['terms_conditions']) ? $sitecontent['terms_conditions'] : '' }}</textarea>
                            </div>
                        </div>
