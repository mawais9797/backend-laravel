        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="sec2_forget_password_text">Section2 Forget Password
                                Text</label>
                            <input class="form-control" id="sec2_forget_password_text" type="text"
                                name="sec2_forget_password_text"
                                value="{{ $sitecontent['sec2_forget_password_text'] ?? '' }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label" for="sec2_no_account_text">Section2 No Account Text
                                Text</label>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="sec2_signup_text">Section2 Signup Text
                            </label>
                            <input class="form-control" id="sec2_signup_text" type="text" name="sec2_signup_text"
                                value="{{ $sitecontent['sec2_signup_text'] ?? '' }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="sec2_signup_link">Section2 Signup Link
                            </label>
                            <input class="form-control" id="sec2_signup_link" type="text" name="sec2_signup_link"
                                value="{{ $sitecontent['sec2_signup_link'] ?? '' }}">
                        </div>
                    </div>
