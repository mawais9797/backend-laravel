                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-4">
                                                    <label class="form-label" for="designation">Client Designation
                                                    </label>
                                            ...
                                            <div class="col-md-12">
                                                <div>
                                                    ...
                                                    <textarea class="form-control" id="message" rows="3" name="message">{{ !empty($row->message) ? $row->message : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3">
