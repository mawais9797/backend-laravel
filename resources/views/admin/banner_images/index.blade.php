...
@section('page_content')
                        ...
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100 border position-relative overflow-hidden">
                                <div class="card-body p-4">
                                    <h4 class="card-title">Banner Image Block</h4>
                                                ...
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="text-center">
                                                        <div class="file_choose_icon">
                                                            <img src="{{ get_site_image_src('images', !empty($row) ? $row->image : '') }}"
    ...
    @else
        {!! breadcrumb('Banner Image', url('/admin/bannerimages/add/')) !!}
        <div class="card">
            <div class="card-body">
                <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-6 crud_thumbnail_icon">
                                                    <img src="{{ get_site_image_src('images', !empty($row->image) ? $row->image : '') }}"
                                                        width="45" />
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                href="{{ url('admin/bannerimages/edit/' . $row->id) }}">
                                                                <i class="fs-4 ti ti-edit"></i>Edit
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                href="{{ url('admin/bannerimages/delete/' . $row->id) }}"
