...
@section('page_content')
    @if (request()->segment(3) == 'edit' || request()->segment(3) == 'add')
        {!! breadcrumb('Add/Update Sub-Category') !!}
                        ...
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100 border position-relative overflow-hidden">
                                <div class="card-body p-4">
                                    <h4 class="card-title">Sub-Category Block</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-lg-12 d-flex align-items-stretch">
                                            <div class="card w-100 border position-relative overflow-hidden">
                                                <div class="card-body p-4">
                                                    <h4 class="card-title">Sub-Category Image</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-4">
                                                    <label class="form-label" for="parent_cat_id">Parent-Category
                                                        Name</label>
                                                    <select class="form-control" id="parent_cat_id" name="parent_cat_id">
                                                        <option value="">Select Parent Category</option>
                                                        @foreach ($cats as $cat)
                                                            <option value="{{ $cat->id }}"
                                                                {{ isset($row->parent_cat_id) && $row->parent_cat_id == $cat->id ? 'selected' : '' }}>
                                                                {{ $cat->cat_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-4">
                                                    <label class="form-label" for="name">* Sub-Category Name
                                                    </label>
                                                    <input class="form-control" id="name" type="text" name="name"
                                                        placeholder="" value="{{ !empty($row->name) ? $row->name : '' }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-end mt-4 gap-6">
                                <button class="btn btn-primary" type="submit">
                                    {{ !empty($row) ? 'Update Sub-Category' : 'Add Sub-Category' }}</button>
                            </div>
                        </div>
    ...
    @else
        {!! breadcrumb('Sub-Categories', url('/admin/sub-categories/add')) !!}
        <div class="card">
            <div class="card-body">
                <div class="row">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                href="{{ url('admin/sub-categories/edit/' . $row->id) }}">
                                                                <i class="fs-4 ti ti-edit"></i>Edit
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                                href="{{ url('admin/sub-categories/delete/' . $row->id) }}"
